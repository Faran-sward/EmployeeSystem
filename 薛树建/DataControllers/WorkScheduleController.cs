...
namespace EmployeeSystem.Controllers.DataControllers
{
    ...
    {
        // localhost:1522/api/WorkSchedule/Get/{"EmployeeID": "E0001", "ContractID": "A0001"}
        // 8.130.119.222:1522/api/WorkSchedule/Get/{"EmployeeID": "E0001", "ContractID": "A0001"}
        [HttpGet("{json}")]
        public IActionResult Get(string json)
        {
            try
            {
                WorkScheduleManager manager = new WorkScheduleManager();  // 负责与数据库交互的manager
                if (!manager.Get(json, out List<WorkSchedule> tables))
                    return StatusCode(500, $"读取数据失败:");  // 获取数据存放在table中

                List<object> jsonResults = new List<object>();

                foreach (WorkSchedule table in tables)
                {
        ...
        // localhost:1522/api/WorkSchedule/Insert/{"EmployeeID": "E0001", "ContractID": "A0002"}
        // 8.130.119.222:1522/api/WorkSchedule/Insert/{"EmployeeID": "E0001", "ContractID": "A0002"}
        [HttpGet("{json}")]
        ...
        // localhost:1522/api/WorkSchedule/Update/{"EmployeeID": "E0001", "ContractID": "A0003"}/{"EmployeeID": "E0001", "ContractID": "A0002"}
        // 8.130.119.222:1522/api/WorkSchedule/Update/{"EmployeeID": "E0001", "ContractID": "A0003"}/{"EmployeeID": "E0001", "ContractID": "A0002"}
        ...
        // localhost:1522/api/WorkSchedule/Delete/{"EmployeeID": "E0001", "ContractID": "A0002"}
        // 8.130.119.222:1522/api/WorkSchedule/Delete/{"EmployeeID": "E0001", "ContractID": "A0002"}
        [HttpGet("{json}")]
