...
namespace EmployeeSystem.Models.DataManager
{
    ...
    public static class SqlGenerator
    {
        ...
        public static string Insert(string table_name, string[] attributes, string[] values)
        {
            StringBuilder sqlBuilder = new StringBuilder();
        ...
        // search_key_names为用于where子句中的属性
        // search_key_values为用于where子句中的属性对应的值
        public static string Update(string table_name, string[] attributes, string[] values, string[] search_key_names, string[] search_key_values)
        {
            StringBuilder sqlBuilder = new StringBuilder();
