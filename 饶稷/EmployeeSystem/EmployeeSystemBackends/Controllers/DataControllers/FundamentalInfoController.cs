...
namespace EmployeeSystem.Controllers.DataControllers
{
    ...
    [ApiController]
    public class FundamentalInfoController : ControllerBase
    {
        [HttpGet("{json}")]
        public IActionResult Get(string json)
        {
            try
            {
                ...
                FundamentalInfoManager manager = new FundamentalInfoManager();  // 负责与数据库交互的manager
                if (!manager.Get(json, out List<FundamentalInfo> tables))
                    return StatusCode(500, $"读取数据失败:");  // 获取数据存放在table中

                List<object> jsonResults = new List<object>();

                foreach (FundamentalInfo table in tables)
                {
        ...
        // localhost:1522/api/FundamentalInfo/Insert/{"EmployeeID": "E0001", "ContractID": "A0002"}
        // 8.130.119.222:1522/api/FundamentalInfo/Insert/{"EmployeeID": "E0001", "ContractID": "A0002"}
        [HttpPost("{json}")]
        ...
        // localhost:1522/api/FundamentalInfo/Update/{"EmployeeID": "E0001", "FundamentalID": "A0003"}/{"EmployeeID": "E0001", "FundamentalID": "A0002"}
        // 8.130.119.222:1522/api/FundamentalInfo/Update/{"EmployeeID": "E0001", "FundamentalID": "A0003"}/{"EmployeeID": "E0001", "FundamentalID": "A0002"}
        ...
        // localhost:1522/api/FundamentalInfo/Delete/{"EmployeeID": "E0001", "ContractID": "A0002"}
        // 8.130.119.222:1522/api/FundamentalInfo/Delete/{"EmployeeID": "E0001", "ContractID": "A0002"}
        [HttpPost("{json}")]
