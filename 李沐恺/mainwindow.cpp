    ...
    , ui(new Ui::MainWindow)
{
    ...
    //合同上传的上传返回按键
    connect(ui->ToContractRegBtn,&QPushButton::clicked,this,&MainWindow::ToContractReg);
    connect(&ContractReg,&ContractReg::ToContractInfo,this,&MainWindow::ToContractInfo);
...
//合同上传的页面切换
void MainWindow::ToContractReg()
{
    this->hide();
    ContractReg.show();
}

void MainWindow::ToContractInfo()
{
    this->show();
    ContractReg.close();
}
