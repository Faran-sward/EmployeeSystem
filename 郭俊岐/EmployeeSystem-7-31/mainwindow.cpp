    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(ui->bscChangeInfo,SIGNAL(clicked(bool)),this,SLOT(bscChangeInfo()));
    connect(ui->bscEnsure,SIGNAL(clicked(bool)),this,SLOT(bscEnsure()));
    connect(ui->bscCancel,SIGNAL(clicked(bool)),this,SLOT(bscCancel));

    ui->bscEnsure->hide();
    ui->bscCancel->hide();

    deploymentRecord("E0001");
    showWorkSchedule();
