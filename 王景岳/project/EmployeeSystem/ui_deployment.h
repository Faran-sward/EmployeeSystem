...
public:
    ...
    void setupUi(QWidget *Deployment)
    {
        ...
        Deployment_3 = new QWidget(Deployment);
        ...
        textBrowser = new QTextBrowser(Deployment_3);
        ...
        dplmtChange = new QPushButton(Deployment_3);
...
"}"));
        ...
        dplmtLeave = new QPushButton(Deployment_3);
...
"}"));
        ...
        deployment = new QTableView(Deployment_3);
        deployment->setObjectName(QString::fromUtf8("deployment"));
        ...
        dplmtDeployment = new QPushButton(Deployment_3);
...
"}"));
        ...
        gridLayout->addWidget(Deployment_3, 0, 0, 1, 1);
    ...
    void retranslateUi(QWidget *Deployment)
    {
        ...
        dplmtDeployment->setText(QCoreApplication::translate("Deployment", "\350\260\203\351\205\215\347\224\263\350\257\267", nullptr));
    } // retranslateUi
