...
MyApply::MyApply(QString employeeID,QWidget *parent) :
    QWidget(parent),
    ui(new Ui::MyApply)
{
    ui->setupUi(this);
...
void MyApply::sendGetRequest(QString url) {
...
void MyApply::initialize() {
    ...
    connect(ui->maplyYear, &QComboBox::currentTextChanged, this, &MyApply::updateDayOptions);
    connect(ui->maplyMonth, &QComboBox::currentTextChanged, this, &MyApply::updateDayOptions);
