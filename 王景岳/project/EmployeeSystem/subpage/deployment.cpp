...
Deployment::Deployment(QString employeeID,QWidget *parent) :
    QWidget(parent),
...
//调配记录查询
void Deployment::deploymentRecord()
{
    QString ID = employeeID;
    QString jsonString = "{\"EmployeeID\":\"" + ID + "\"}";
...
void Deployment::changeComboBoxInitiate(){
...
void Deployment::applyAnimation(){
...
void Deployment::applyButtonAnimation(){
...
void Deployment::applyAddInfomation(){
