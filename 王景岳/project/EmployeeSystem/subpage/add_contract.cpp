...
Add_contract::Add_contract(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::Add_contract)
{
    ui->setupUi(this);
    setWindowFlags (Qt::CustomizeWindowHint);
    connect(ui->ToContractInfoBtn,&QPushButton::clicked,this,&Add_contract::ToContractInfo);
...
void Add_contract::on_lineEdit_editingFinished()
{
...
void Add_contract::on_lineEdit_2_editingFinished()
{
...
void Add_contract::on_lineEdit_3_editingFinished()
{
    new_contract_type=ui->lineEdit_3->text();
}

void Add_contract::on_lineEdit_4_editingFinished()
{
    new_effective_date=ui->lineEdit_4->text();
}

void Add_contract::on_lineEdit_5_editingFinished()
{
    new_inoperative_date=ui->lineEdit_5->text();
}

void Add_contract::on_lineEdit_6_editingFinished()
{
    new_document_link=ui->lineEdit_6->text();
}

void Add_contract::encode_url(QString str, QByteArray &outArr)
{
...
void Add_contract::contract_upload(void)
{
