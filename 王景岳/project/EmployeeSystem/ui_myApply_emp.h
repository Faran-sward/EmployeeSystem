/********************************************************************************
** Form generated from reading UI file 'myApply_emp.ui'
**
...
#ifndef UI_MYAPPLY_EMP_H
#define UI_MYAPPLY_EMP_H
...
public:
    ...
    void setupUi(QWidget *MyApply_Emp)
    {
        if (MyApply_Emp->objectName().isEmpty())
            MyApply_Emp->setObjectName(QString::fromUtf8("MyApply_Emp"));
        MyApply_Emp->resize(800, 600);
        verticalLayout = new QVBoxLayout(MyApply_Emp);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        widget_2 = new QWidget(MyApply_Emp);
...
"}"));
        ...
        widget = new QWidget(MyApply_Emp);
...
"}"));
        ...
        outside = new QWidget(MyApply_Emp);
...
"}"));
        ...
        retranslateUi(MyApply_Emp);

        tabWidget->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(MyApply_Emp);
    } // setupUi

    void retranslateUi(QWidget *MyApply_Emp)
    {
        MyApply_Emp->setWindowTitle(QCoreApplication::translate("MyApply_Emp", "Widget", nullptr));
        label_4->setText(QCoreApplication::translate("MyApply_Emp", "\346\210\221\347\232\204\347\224\263\350\257\267\350\256\260\345\275\225", nullptr));
        label->setText(QCoreApplication::translate("MyApply_Emp", "\345\271\264", nullptr));
        label_2->setText(QCoreApplication::translate("MyApply_Emp", "\346\234\210", nullptr));
        label_3->setText(QCoreApplication::translate("MyApply_Emp", "\346\227\245", nullptr));
        maplyGet->setText(QCoreApplication::translate("MyApply_Emp", "\347\255\233\351\200\211", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab), QCoreApplication::translate("MyApply_Emp", "\345\244\204\347\220\206\344\270\255", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QCoreApplication::translate("MyApply_Emp", "\345\267\262\345\244\204\347\220\206", nullptr));
    } // retranslateUi

};

namespace Ui {
    class MyApply_Emp: public Ui_MyApply_Emp {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_MYAPPLY_EMP_H
