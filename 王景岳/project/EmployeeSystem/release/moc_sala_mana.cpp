...
QT_MOC_LITERAL(3, 28, 15), // "onChangeClicked"
QT_MOC_LITERAL(4, 44, 9) // "hideRight"

    },
    "Sala_Mana\0slotCountMessage\0\0onChangeClicked\0"
    "hideRight"
};
...
void Sala_Mana::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Sala_Mana *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slotCountMessage(); break;
        case 1: _t->onChangeClicked(); break;
        case 2: _t->hideRight(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
