...
public:
    ...
    Add_post *application;
    Change_Auth *application_2;
    QWidget *widget;
    ...
    void setupUi(QWidget *Dept_Pos)
    {
        ...
        gridLayout_2 = new QGridLayout(Dept_Pos);
        gridLayout_2->setObjectName(QString::fromUtf8("gridLayout_2"));
        gridLayout_2->setHorizontalSpacing(0);
        gridLayout_2->setVerticalSpacing(15);
        gridLayout_2->setContentsMargins(30, 15, 30, 30);
        ...
        application = new Add_post(Dept_Pos);
        ...
        verticalLayout->addWidget(application);

        application_2 = new Change_Auth(Dept_Pos);
        application_2->setObjectName(QString::fromUtf8("application_2"));
        sizePolicy2.setHeightForWidth(application_2->sizePolicy().hasHeightForWidth());
        application_2->setSizePolicy(sizePolicy2);
        application_2->setMinimumSize(QSize(0, 0));
        application_2->setMaximumSize(QSize(0, 16777215));

        verticalLayout->addWidget(application_2);
        ...
        if (auth_table->columnCount() < 4)
            auth_table->setColumnCount(4);
        ...
        auth_table->setHorizontalHeaderItem(3, __qtablewidgetitem3);
        auth_table->setObjectName(QString::fromUtf8("auth_table"));
        auth_table->setStyleSheet(QString::fromUtf8(""));
        auth_table->horizontalHeader()->setVisible(true);
        auth_table->horizontalHeader()->setHighlightSections(true);
        auth_table->verticalHeader()->setVisible(false);
        ...
        post_table->setHorizontalHeaderItem(0, __qtablewidgetitem4);
        QTableWidgetItem *__qtablewidgetitem5 = new QTableWidgetItem();
        post_table->setHorizontalHeaderItem(1, __qtablewidgetitem5);
        QTableWidgetItem *__qtablewidgetitem6 = new QTableWidgetItem();
        post_table->setHorizontalHeaderItem(2, __qtablewidgetitem6);
        QTableWidgetItem *__qtablewidgetitem7 = new QTableWidgetItem();
        post_table->setHorizontalHeaderItem(3, __qtablewidgetitem7);
        QTableWidgetItem *__qtablewidgetitem8 = new QTableWidgetItem();
        post_table->setHorizontalHeaderItem(4, __qtablewidgetitem8);
        ...
        staff_table->setHorizontalHeaderItem(0, __qtablewidgetitem9);
        QTableWidgetItem *__qtablewidgetitem10 = new QTableWidgetItem();
        staff_table->setHorizontalHeaderItem(1, __qtablewidgetitem10);
        QTableWidgetItem *__qtablewidgetitem11 = new QTableWidgetItem();
        staff_table->setHorizontalHeaderItem(2, __qtablewidgetitem11);
        QTableWidgetItem *__qtablewidgetitem12 = new QTableWidgetItem();
        staff_table->setHorizontalHeaderItem(3, __qtablewidgetitem12);
        staff_table->setObjectName(QString::fromUtf8("staff_table"));
        staff_table->verticalHeader()->setVisible(false);
    ...
    void retranslateUi(QWidget *Dept_Pos)
    {
        ...
        ___qtablewidgetitem->setText(QCoreApplication::translate("Dept_Pos", "\350\201\214\344\275\215\347\274\226\345\217\267", nullptr));
        ...
        QTableWidgetItem *___qtablewidgetitem3 = auth_table->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QCoreApplication::translate("Dept_Pos", "\346\223\215\344\275\234", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab), QCoreApplication::translate("Dept_Pos", "\347\274\226\345\210\266", nullptr));
        QTableWidgetItem *___qtablewidgetitem4 = post_table->horizontalHeaderItem(0);
        ___qtablewidgetitem4->setText(QCoreApplication::translate("Dept_Pos", "\350\201\214\344\275\215\347\274\226\345\217\267", nullptr));
        QTableWidgetItem *___qtablewidgetitem5 = post_table->horizontalHeaderItem(1);
        ___qtablewidgetitem5->setText(QCoreApplication::translate("Dept_Pos", "\350\201\214\344\275\215\345\220\215\347\247\260", nullptr));
        QTableWidgetItem *___qtablewidgetitem6 = post_table->horizontalHeaderItem(2);
        ___qtablewidgetitem6->setText(QCoreApplication::translate("Dept_Pos", "\350\201\214\344\275\215\347\261\273\345\236\213", nullptr));
        QTableWidgetItem *___qtablewidgetitem7 = post_table->horizontalHeaderItem(3);
        ___qtablewidgetitem7->setText(QCoreApplication::translate("Dept_Pos", "\350\201\214\344\275\215\347\255\211\347\272\247", nullptr));
        QTableWidgetItem *___qtablewidgetitem8 = post_table->horizontalHeaderItem(4);
        ___qtablewidgetitem8->setText(QCoreApplication::translate("Dept_Pos", "\346\223\215\344\275\234", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QCoreApplication::translate("Dept_Pos", "\345\262\227\344\275\215", nullptr));
        QTableWidgetItem *___qtablewidgetitem9 = staff_table->horizontalHeaderItem(0);
        ___qtablewidgetitem9->setText(QCoreApplication::translate("Dept_Pos", "\345\221\230\345\267\245\345\217\267", nullptr));
        QTableWidgetItem *___qtablewidgetitem10 = staff_table->horizontalHeaderItem(1);
        ___qtablewidgetitem10->setText(QCoreApplication::translate("Dept_Pos", "\345\275\223\345\211\215\350\201\214\344\275\215\347\274\226\345\217\267", nullptr));
        QTableWidgetItem *___qtablewidgetitem11 = staff_table->horizontalHeaderItem(2);
        ___qtablewidgetitem11->setText(QCoreApplication::translate("Dept_Pos", "\345\275\223\345\211\215\346\211\200\345\234\250\345\237\216\345\270\202", nullptr));
        QTableWidgetItem *___qtablewidgetitem12 = staff_table->horizontalHeaderItem(3);
        ___qtablewidgetitem12->setText(QCoreApplication::translate("Dept_Pos", "\345\205\245\350\201\214\346\227\266\351\227\264", nullptr));
